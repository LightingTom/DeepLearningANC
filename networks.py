...
class GLSTM(nn.Module):
    def __init__(self, in_features=None, out_features=None, mid_features=None, hidden_size=512, groups=2):
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3_t_1 = GluConvTranspose2d(in_channels=128, out_channels=32, kernel_size=(1,3), stride=(1,2), output_padding=(0,1))
        ...
        self.conv3_t_2 = GluConvTranspose2d(in_channels=128, out_channels=32, kernel_size=(1,3), stride=(1,2), output_padding=(0,1))
    ...
    def forward(self, x):
        ...
        d1_1 = d1_1.squeeze(1).permute((0, 2, 1))
        d1_2 = d1_2.permute((0,1,3,2))
        out1 = self.fc1(d1_1)
        out2 = self.fc2(d1_2).squeeze(1)
